...
public final class Commons {
    ...
    public static Map<String, String> social() {
        ...
        map.put("bokeyuan", WebConst.initConfig.get(prefix + "bokeyuan"));
        map.put("tiktok", WebConst.initConfig.get(prefix + "tiktok"));
        map.put("github", WebConst.initConfig.get(prefix + "github"));
        map.put("ins", WebConst.initConfig.get(prefix + "ins"));
